---
template: Shopify Customer Welcome
paste-into: Shopify Admin → Settings → Notifications → Customer notifications → Customer welcome
source-file: aydins-customer-welcome-shopify.html
version: Phase 3 (built 2026-05-16, no line items so no image rule)
---

# Paste-Ready Code: Customer Welcome

**How to use:** Copy everything inside the code block below. In Shopify, replace the entire email body of the **Customer welcome** template, then **Save**. **Preview** before going live.

```liquid
{% comment %}
Aydins Jewelry - Shopify Customer welcome notification template
  ...
  <div class="wrap">
    <div class="container">
      ...
      <div class="content">
        ...
        <p>Your Aydins account is ready.</p>
        <p>You can use it to view orders, check order history, and keep your details current for future purchases.</p>

        {% if shop.url %}
          <p><a class="button" href="{{ shop.url }}/account">Go to your account</a></p>
        {% endif %}

        <div class="panel">
          <h2>What we do</h2>
          <p>We engrave and ship wedding bands from our shop in Irving, Texas. Tungsten, titanium, Damascus, gold, ceramic, meteorite, dinosaur bone, and custom engraving all run through the same small team.</p>
        </div>

        <div class="panel">
          <h2>Need help choosing?</h2>
          <p>Reply to this email if you need help with sizing, engraving, materials, or finding a specific ring. Real people answer.</p>
        </div>
