---
template: Shopify Return Created
paste-into: Shopify Admin → Settings → Notifications → Customer notifications → Return created
source-file: aydins-return-created-shopify.html
version: V1 (built 2026-05-17)
---

# Paste-Ready Code: Return Created

**How to use:** Copy everything inside the code block below. In Shopify, replace the entire email body of the **Return created** template, then **Save**. **Preview** before going live.

```liquid
{% comment %}
Aydins Jewelry - Shopify Return created notification template
...
<head>
  ...
  <title>Your return is in progress: {{ shop.name }}</title>
  <!--[if mso]>
...
<body>
  <div class="wrap">
    <div class="container">
      ...
      <div class="content">
        <h1>Your return is in progress.</h1>
        <p>Hi {{ customer_name }},</p>
        <p>We have started a return for items from Aydins order {{ order_label }}. The details are below.</p>
        ...
        <p>Reply to this email with any questions before you ship the package.</p>
      </div>
