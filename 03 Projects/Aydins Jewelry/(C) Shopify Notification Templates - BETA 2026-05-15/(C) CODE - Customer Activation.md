---
template: Shopify Customer Account Activation
paste-into: Shopify Admin → Settings → Notifications → Customer notifications → Customer account activation
source-file: aydins-customer-activation-shopify.html
version: Phase 3 (built 2026-05-16, no line items so no image rule)
---

# Paste-Ready Code: Customer Account Activation

**How to use:** Copy everything inside the code block below. In Shopify, replace the entire email body of the **Customer account activation** template, then **Save**. **Preview** before going live.

```liquid
{% comment %}
Aydins Jewelry - Shopify Customer activation notification template
...
{% assign customer_name = customer.first_name | default: billing_address.first_name | default: 'there' %}
  ...
  <div class="wrap">
    <div class="container">
      ...
      <div class="content">
        ...
        <p>Your Aydins account is almost ready. Activate it to view your orders and manage your customer details.</p>
        ...
        <div class="panel">
          ...
          <p>Your account gives you a cleaner way to keep track of Aydins orders, especially if you come back for another ring, sizing help, or engraving support later.</p>
        </div>

        <p>If you did not request this account, you can ignore this email. If something looks wrong, reply and we will help.</p>
