---
template: Shopify Return Request Received
paste-into: Shopify Admin → Settings → Notifications → Customer notifications → Return request received
source-file: aydins-return-request-received-shopify.html
version: V1 (built 2026-05-17)
---

# Paste-Ready Code: Return Request Received

**How to use:** Copy everything inside the code block below. In Shopify, replace the entire email body of the **Return request received** template, then **Save**. **Preview** before going live.

```liquid
{% comment %}
Aydins Jewelry - Shopify Return request received notification template
...
<head>
  ...
  <title>We got your return request: {{ shop.name }}</title>
  <!--[if mso]>
...
<body>
  <div class="wrap">
    <div class="container">
      ...
      <div class="content">
        <h1>We got your return request.</h1>
        <p>Hi {{ customer_name }},</p>
        <p>Thanks for reaching out about Aydins order {{ order_label }}. Your return request is in our queue.</p>

        <div class="panel">
          <h2>What happens next</h2>
          <p>We will review your request and reply within 1-2 business days with the next step.</p>
          <p class="muted">If your request involves a sizing or fit issue, mention that in your reply. Exchanges are sometimes a better fit than a full return, especially on engraved pieces.</p>
        </div>
        ...
        <p>Hang tight. We will be in touch shortly.</p>
      </div>
